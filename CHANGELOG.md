...
- Fixed `test_single_quant` nf-test running the plain `test` profile and never exercising the `QUANT` subworkflow [#475](https://github.com/nf-core/mhcquant/pull/475)
